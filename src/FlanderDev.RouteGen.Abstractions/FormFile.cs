...
/// non-generic form when there's no extra data to attach to the upload. This is not a general
/// extensibility point, though: RouteGen's <c>[File]</c> parameter-shape detection only
/// recognizes <see cref="FormFile"/> and <see cref="FormFile{TMetadata}"/> by name specifically
/// (diagnostic RG0010 otherwise), so a third-party subclass of your own would be rejected at
/// compile time even though it would work fine structurally.
/// </summary>
/// <param name="Content">
